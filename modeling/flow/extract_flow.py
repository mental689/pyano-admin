...
try:
	from modeling.flow.correlation import correlation # the custom cost volume layer
except:
...
if __name__ == '__main__':
	...
	parser.add_argument('--group', dest='groupID', type=int, default=2, help='Django JobGroup ID')
	args = parser.parse_args()

	extract_jobgroup(args.groupID, args.strModel)
