function instructions(job, h)
{
    ...
    h.append("<img src='/static/images/vatic/box.jpg' align='right'>");
    ...
    h.append("<img src='/static/images/vatic/classify.jpg' align='right'>");
    ...
    h.append("<img src='/static/images/vatic/outsideoccluded.jpg' align='right'>");
    ...
    h.append("<p>If there are many objects on the screen, it can become difficult to select the right bounding box. By pressing the lock button <img src='/static/images/vatic/lock.jpg'> on an object's sidebar rectangle, you can prevent changes to that track. Press the lock button again to renable modifications.</p>");
    ...
    //h.append("<img src='/static/images/vatic/secret.png'>");
    //h.append("<img src='/static/images/vatic/everyobject.jpg'>");
    ...
    h.append("<table><tr><td><img src='/static/images/vatic/tight-good.jpg'></td><td><img src='/static/images/vatic/tight-bad.jpg'></td></tr><tr><th>Good</th><th>Bad</th></tr></table>");
    ...
    h.append("<img src='/static/images/vatic/sequence1.jpg'> ");
    h.append("<img src='/static/images/vatic/sequence3.jpg'> ");
    h.append("<img src='/static/images/vatic/sequence4.jpg'><br>");
    ...
    h.append("<img src='/static/images/vatic/entering1.png'> <img src='/static/images/vatic/entering2.png'> <img src='/static/images/vatic/entering3.png'> <img src='/static/images/vatic/entering4.png'><br>");
    ...
    h.append("<img src='/static/images/vatic/outofcar1.png'> <img src='/static/images/vatic/outofcar2.png'> <img src='/static/images/vatic/outofcar3.png'> <br>");
